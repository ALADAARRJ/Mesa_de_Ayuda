                                ...
                                case "1";
                                    ?>
                                        <div class="alert alert-danger" role="alert">
                                            ...
                                            <div class="d-flex aligin-items-center justify-content-start">
                                                <i class="icon ion-ios-checkmark alert-icon tx-32 mg-t-5 mg-xs-t-0"></i>
                                                <span> El Correo y/o la Contraseña son incorrectos.</span>
                                            </div>
                                        </div>
                                    <?php
                                break;
                                case "2";
                                    ?>
                                        <div class="alert alert-warning" role="alert">
                                            ...
                                            <div class="d-flex aligin-items-center justify-content-start">
                                                <i class="icon ion-ios-checkmark alert-icon tx-32 mg-t-5 mg-xs-t-0"></i>
                                                <span> Los campos no pueden quedar vacios.</span>
                                            </div>
                                        </div>
                                    <?php
                                break;
